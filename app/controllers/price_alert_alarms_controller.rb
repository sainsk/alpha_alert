class PriceAlertAlarmsController < ApplicationController
  ...
  def create
    ...
    cmd_string = "python /opt/HackNight/hacknight3.0/persecurity_script.py  " + @price_alert_alarm.symbol + " " + @price_alert_alarm.mobile_number + " " + @price_alert_alarm.cap_price.round.to_s + " "+ @price_alert_alarm.floor_price.round.to_s + " "+call_counter+" " + rand(6237).to_s
    p cmd_string
    system cmd_string 
