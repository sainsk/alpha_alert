class PriceAlertAlarmsController < ApplicationController
  ...
  def create
    ...
    cmd_string = "python /opt/HackNight/hacknight3.0/persecurity_script.py  " + @price_alert_alarm.symbol + " " + @price_alert_alarm.mobile_number + " " + @price_alert_alarm.cap_price.round.to_s + " "+ @price_alert_alarm.floor_price.round.to_s + "  3 11 "
    p cmd_string
    system cmd_string 
